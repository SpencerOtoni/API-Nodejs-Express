...
class Tabelas {
    ...
    criarUser(){
        const sql = 'CREATE TABLE IF NOT EXISTS User(id int NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), nome varchar(50), senha varchar(20), email varchar(50))'
    ...
    criarPets(){
        const sql = 'CREATE TABLE IF NOT EXISTS Pets(id int NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), nome varchar(50), imagem varchar(200), idUser int NOT NULL, FOREIGN KEY (idUser) REFERENCES User (id))'
